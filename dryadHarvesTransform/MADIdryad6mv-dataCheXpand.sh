#!/bin/bash
# Latest update: 2024-09-05 Script for moving datafiles to data folder and then get md5.txt -> checkSums.xml, pulling in schemas and filext2mimetypeMapMAIN.xml document parameter in package, for use in next step xslt dryad7DataCite2FGS.xsl 
#Origin: //dryadHarvesTransform/dryadPages2023-10-20/outputNewBatchConv/dryadSUaffiliatesPage1/dryad.2bvq83bms 

cd //dryadHarvesTransform/dryadPages20240725json2XMLoutputUA/dryadSUaffiliatesPage2
